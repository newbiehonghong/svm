...
<script>
    import { queryAllRoles, saveRole, updateRole, deleteRole, saveRoleUsers, saveRolePermissions } from 'svm-web-security/api/role';
    import { queryAllUsers, queryUsersByRoleId } from 'svm-web-security/api/user';
    import { queryPermissions, queryPermissionsByRoleId } from 'svm-web-security/api/permission';
    export default {
        name: 'RoleManage',
        data() {
            return {
