...
<script>
    import { saveUser, getUploadUrl, getDownloadUrl, getUploadHeader } from '../api/user';
    ...
    export default {
        ...
        computed: {
            uploadURL() {
                return getUploadUrl(this);
            },
            uploadHeaders() {
                return getUploadHeader(this);
            }
        },
        methods: {
            doAvatarSuccess(res) {
                ...
                this.imageUrl = getDownloadUrl(this, res);
            },
            ...
            doSubmit(formName) {
                saveUser(this, this.user).then((res) => {
