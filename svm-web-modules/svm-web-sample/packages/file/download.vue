...
<script>
    ...
    import { queryDownloadUsers, downloadPicture, getDownloadUrl } from '../api/user';
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                queryDownloadUsers(this, this.currentPage).then((res) => {
            ...
            doDownload(index, row) {
                downloadPicture(this, row.attachmentId).then((res) => {
                    let blob = res.data;
            ...
            getImageUrl(attachmentId) {
                return getDownloadUrl(this, attachmentId);
            }
        }
    }
